...
from models.vgg_double import VGG
...
# Model
net = VGG(opt.sigma_0, len(trainset), 'VGG16', init_noise=0.2, inner_noise=0.1)
net.cuda()
...
def test(epoch):
    ...
    # Save checkpoint.
    torch.save(net.state_dict(), './checkpoint/vgg16_double.pth')
